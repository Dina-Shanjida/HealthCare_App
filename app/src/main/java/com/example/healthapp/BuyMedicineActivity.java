...
public class BuyMedicineActivity extends AppCompatActivity {
    ...
    private String[] packages_details ={
            ...
            "It promotes health as well as skin benefit\n"+
                    "It helps in reduicing skin blemish and pigmentation\n"+
            ...
            "Helps to relieve fever and bring down a high temperature\n"+
                    "Suitable for people with a heart conditon or high blood pressure",
            "Relieves the symptoms of a bacterial thoat infection and soothes the recovery process\n"+
                    "Provides a warm and comforting feeling during sore throat",
            "Reduces the risk of calcium deficiency, Rickets and Osteoporosis\n"+
                    "Promotes mobility and flexibility of joints",
            "Helps to reduce the iron deficiency due to chronic blood loss of low intake of iron"
